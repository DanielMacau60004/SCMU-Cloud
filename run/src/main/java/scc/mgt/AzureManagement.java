...
public class AzureManagement {
    ...
    static final String MY_SUFFIX = "djv"; // Add your suffix here
    ...
    static final Region[] REGIONS = new Region[]{Region.EUROPE_WEST, Region.BRAZIL_SOUTH}; // Define the regions to deploy resources here
    ...
    static final String[] AZURE_FUNCTIONS_NAME = Arrays.stream(REGIONS).map(reg -> "scc24function-" + reg.name() + "-" + MY_SUFFIX)
            .toArray(String[]::new);
    ...
    public static AzureResourceManager createManagementClient() throws IOException {
        ...
        AzureResourceManager azure = AzureResourceManager
                ...
                .withSubscription("d26de328-a442-4578-9b31-5c74e2fb45bf");
                    ...
                    Thread th = new Thread(() -> {
                        try {
                            ...
                            createCosmosCollection(cosmosClient, AZURE_COSMOSDB_DATABASE, "rentals", "/houseId",
                                    null);
                            createCosmosCollection(cosmosClient, AZURE_COSMOSDB_DATABASE, "questions", "/houseId",
                                    null);
                            createCosmosCollection(cosmosClient, AZURE_COSMOSDB_DATABASE, "promotions", "/houseId",
                                    null);
